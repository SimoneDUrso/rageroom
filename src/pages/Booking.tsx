...
export default function Booking() {
  ...
  const validatePayment = (): boolean => {
    ...
    if (!isValidLuhn(cleanCardNumber)) {
      setError("Il numero della carta non è valido.");
      return false;
    }
    ...
    if (isNaN(month) || month < 1 || month > 12) {
      setError("Mese non valido (01-12).");
      return false;
    }
            ...
            <form onSubmit={handlePayment} className="animate-in fade-in slide-in-from-top-4 duration-500 pt-8 border-t border-dashed border-gray-200">
              ...
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-xl font-bold text-gray-800 flex items-center gap-2">
                  <CreditCard className="text-primary"/> Dati Pagamento
                </h3>
                ...
                <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full p-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary outline-none transition bg-white pl-10"
              ...
              <div className="mt-6 flex items-start gap-3 text-xs text-gray-500 bg-yellow-50 p-4 rounded-xl text-yellow-800 border border-yellow-100">
                 ...
                 <div>
                   ...
                   <p>Procedendo confermi che i dati inseriti sono reali. La prenotazione non è rimborsabile.</p>
                 </div>
              </div>
