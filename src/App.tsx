          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              ...
              <div className="hidden md:flex items-center space-x-8">
                ...
                <Link to="/about" className="text-sm font-medium text-gray-600 hover:text-blue-600 transition-colors">Chi Siamo</Link>
                <Link to="/prenota" className="px-5 py-2.5 bg-blue-600 text-white text-sm font-medium rounded-full shadow-lg shadow-blue-200 hover:bg-blue-700 hover:shadow-xl transition-all transform hover:-translate-y-0.5">
                  Prenota Ora
                </Link>
              </div>

              {/* Mobile Menu Icon (Solo decorativo per ora) */}
